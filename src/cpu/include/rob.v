...
// integer unit
`define RS_INT_ADDR_WIDTH     3
`define RS_INT_SIZE           `MAKE_SIZE(`RS_INT_ADDR_WIDTH)

// mult div unit
`define RS_MDU_ADDR_WIDTH     3
...
// load store unit
`define RS_LSU_ADDR_WIDTH     3
`define RS_LSU_SIZE           `MAKE_SIZE(`RS_LSU_ADDR_WIDTH)

// branch unit
`define RS_BRU_ADDR_WIDTH     3
`define RS_BRU_SIZE           `MAKE_SIZE(`RS_BRU_ADDR_WIDTH)

// co-processor unit
`define RS_COU_ADDR_WIDTH     3
`define RS_COU_SIZE           `MAKE_SIZE(`RS_COU_ADDR_WIDTH)
